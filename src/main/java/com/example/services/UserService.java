...
private UserDao uDao;
	...
	public User signUp(String first, String last, String email, String username, String password, int userRoleId) throws UsernameAlreadyExistsException {
		
		User u = new User(first, last, email, username, password, userRoleId);
